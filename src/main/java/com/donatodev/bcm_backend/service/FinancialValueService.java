...
public class FinancialValueService {
	 ...
	 * <p>
	 * Admin users retrieve all values,
	 * managers only values related to contracts they manage.
	 *
	...
	/**
	 * Checks if the authenticated user has access to the specified financial value.
	 * <p>
	 * Admins have access to all values.
	 * Managers only have access to values related to contracts they manage.
	 *
